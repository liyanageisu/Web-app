...
export class NotificationsComponent implements OnInit {
 ...
 // constructor(private toastr: ToastrService) {}
  ...
  //     switch(color){
  //       case 1:
  //       this.notService.info('<span class="tim-icons icon-bell-55" [data-notify]="icon"></span> Welcome to <b>Black Dashboard Angular</b> - a beautiful freebie for every web developer.', '', {
  //          disableTimeOut: true,
  //          closeButton: true,
  //          enableHtml: true,
